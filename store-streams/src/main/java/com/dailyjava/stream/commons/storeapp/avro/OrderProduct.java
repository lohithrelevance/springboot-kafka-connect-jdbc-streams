...
public class OrderProduct extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3839241313722097180L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderProduct\",\"namespace\":\"com.dailyjava.stream.commons.storeapp.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":\"string\"},{\"name\":\"product_id\",\"type\":\"long\"},{\"name\":\"unit\",\"type\":\"int\"}],\"connect.name\":\"com.dailyjava.stream.commons.storeapp.avro.OrderProduct\"}");
   ...
   */
  public static com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder newBuilder() {
    return new com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder();
  }
   ...
   * @return A new OrderProduct RecordBuilder
   */
  public static com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder newBuilder(com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder other) {
    if (other == null) {
      return new com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder();
    } else {
      return new com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder(other);
    }
  }
   ...
   * @return A new OrderProduct RecordBuilder
   */
  public static com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder newBuilder(com.dailyjava.stream.commons.storeapp.avro.OrderProduct other) {
    if (other == null) {
      return new com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder();
    } else {
      return new com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderProduct>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dailyjava.stream.commons.storeapp.avro.OrderProduct other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.order_id)) {
        this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder clearOrderId() {
      order_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder setProductId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder clearProductId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder setUnit(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dailyjava.stream.commons.storeapp.avro.OrderProduct.Builder clearUnit() {
